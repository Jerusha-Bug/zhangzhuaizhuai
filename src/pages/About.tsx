              ...
              >
                ...
                <div className="space-y-4 flex-1">
                  {photographerInfo.biography.split("\n\n").map((paragraph, index) => (
                    <p key={index} className="text-sm md:text-base font-light leading-[3.2] text-muted-foreground">
                      {paragraph}
                    </p>
                  ))}
                </div>
                ...
                {/* Contact Info - 底部对齐 */}
                <div className="pt-4 space-y-2 mt-auto mb-8">
